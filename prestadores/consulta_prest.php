    ...
    <div class="container" style="margin-top: 40px;">
        ...
        <table border="1" width="100%" class="table  table-striped" style="margin: 40px 0 60px 0; ">
            ...
            while ($prest = mysqli_fetch_assoc($resultado_prest)) {
                ...
                echo $prest['cidade'] . "</td><td>" . $prest['estado'] . "</td><td>" . $prest['telefone'] . "</td><td>" . $prest['email'] . "</td><td style='text-align: center;'><a href='edit_prest.php?id_prestador=" . $prest['id_prestador'] . "'>Editar</a>";

    ...
    <div class="container" style="margin-top: 40px;">
        ...
        <table border="1" width="100%" class="table  table-striped" style="margin: 40px 0 60px 0; ">
            ...
            while ($cli = mysqli_fetch_assoc($resultado_cli)) {
                ...
                echo $cli['cidade'] . "</td><td>" . $cli['estado'] . "</td><td>" . $cli['telefone_fixo'] . "</td><td>" . $cli['celular'] . "</td><td>" . $cli['email'] . "</td><td style='text-align: center;'><a href='edit_cli.php?id_cliente=" . $cli['id_cliente'] . "'>Editar</a>";

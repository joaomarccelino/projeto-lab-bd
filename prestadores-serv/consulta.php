...
<body style="background-color: #fafafa;">
    ...
    <div class="container" style="margin-top: 40px;">
        ...
        <table border="1" width="100%" class="table  table-striped" style="margin: 40px 0 60px 0; ">
            ...
            $result_serv = "SELECT ps.id_servico, ps.id_prestador, p.nome, s.servico FROM prestadores_servicos AS ps, prestadores AS p, servicos AS s WHERE ps.id_prestador = p.id_prestador AND ps.id_servico = s.id_servico";
